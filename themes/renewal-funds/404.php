			...
			<section class="error-404 not-found">
				...
				<div class="page-content">
					...
					<div class="error-content">
						<p><?php echo esc_html("Sorry about that, but the page you are looking for doesn't exist.  Please head back to the home page and try again.  If the problem persists, please")?> <a href="mailto:123@123.com"> <?php echo email ?></a><?php echo esc_html(" us."); ?></p>
					</div>
