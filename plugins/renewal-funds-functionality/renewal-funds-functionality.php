<?php
 /**
 *
 * @package   Renewal Funds Functionality
 * @author    Team Renewal Funds <j@solaris.org.uk>
 * @license   GPL-2.0+
 * @copyright 2015 Team Renewal Funds
 *
 * @wordpress-plugin
 * Plugin Name: Renewal Funds Functionality
